    ...
    try:
        ...
        if hands:
            ...
            if len(lmList) > 0:
                ...
                if fingers[0] == 0 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1:signText = "Hello!"
                # If four fingers are up set 'signText' to "How are your?"
                if fingers[0] == 1 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1: signText = "How are your?"
                # If thumb and small finger is up set 'signText' to "I was on a call."
                if fingers[0] == 0 and fingers[1] == 0 and fingers[2] == 0 and fingers[3] == 0 and fingers[4] == 1:signText = "I was on a call."
                # If first two fingers are up set 'signText' to "Be Quick!"
                if fingers[0] == 1 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 0 and fingers[4] == 0:signText = "Be Quick!"
    
                # If last three fingers are up set 'signText' to "Urgent work!"
                if fingers[0] == 1 and fingers[1] == 0 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 1:signText = "Urgent work!"
                # If all fingers and thumb are down set 'signText' to "Stop"
                if fingers[0] == 1 and fingers[1] == 0 and fingers[2] == 0 and fingers[3] == 0 and fingers[4] == 0:signText = "Stop"
